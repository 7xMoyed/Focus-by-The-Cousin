...
const common = {
  ar: {
    intro: "بس كم سؤال خفيف، ونحاول نلقى لك المكان اللي يناسب جلستك هذي بالذات 🧠✨",
    start: "يلا نبدأ 🚀",
    back: "رجوع",
    continue: "نكمل",
    ...
    prioritiesTitle: "وش أهم شي عندك اليوم؟ ✨",
    ...
    teaserTitle: "لقينا لك كم مكان يناسب جلستك 🎯",
    teaserDescription: "هذي لمحة سريعة—كمّل حسابك ونوريك الخيارات كاملة.",
    teaserMatch: "اختيار مناسب لجلستك",
    reveal: "ورّني أماكني",
  ...
  en: {
    intro:
      "Just a few quick questions, and we’ll help find the place that fits this session best. 🧠✨",
    start: "Let’s go 🚀",
    back: "Back",
    continue: "Continue",
    ...
    prioritiesTitle: "What matters most today? ✨",
    ...
    teaserTitle: "We found some matches for you 🎯",
    teaserDescription: "Here’s a quick peek—create your account to see the full list.",
    teaserMatch: "A strong fit for this session",
